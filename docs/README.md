...
**Last docs refresh:** **v0.5.111** (2026-07-19) · suite **556** tests · `VERSION` in `server/config.py` · **humans ≠ agents** · README GitHub polish · `/thank` · offline invite clear · last push `3a5c5c2` (v0.5.98)
