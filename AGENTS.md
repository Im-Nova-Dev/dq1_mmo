...
**Version:** `0.5.138` (`server/config.py` → `VERSION`) · **714** tests in `server/tests/run_tests.py`  
...
Keep badges at **0.5.138** / **714** until the suite or `VERSION` changes.  
Last **pushed** ship: `081bc0a` / `317eb5c` (v0.5.137). Shipping **0.5.138**.
**Docs map:** [docs/README.md](docs/README.md) — audience rules for both trees.  
Docs pass (**this run**): badges **0.5.138 / 714** · askwhere handler extract · protocol only here.
