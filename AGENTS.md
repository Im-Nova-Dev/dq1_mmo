...
**Version:** `0.5.135` (`server/config.py` → `VERSION`) · **699** tests in `server/tests/run_tests.py`  
...
Keep badges at **0.5.135** / **699** until the suite or `VERSION` changes.  
Last **pushed** ship: `4852818` / `9e235e1` (v0.5.134). Shipping **0.5.135**.
**Docs map:** [docs/README.md](docs/README.md) — audience rules for both trees.  
Docs pass (**this run**): badges **0.5.135 / 699** · roll handler extract · protocol only here.
